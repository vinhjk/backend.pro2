...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().
                ...
                .antMatchers("/api/auth/learningPrograms").permitAll()
                .antMatchers("/api/auth/learningOutcomes").permitAll()
                .antMatchers("/api/auth/objectives").permitAll()
                .antMatchers("/api/auth/learningActivities").permitAll()
